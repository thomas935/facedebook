...
class Server {
    public static void main(String[] args)
    {
        ...
        String[] request = {
            ...
            "CREATE TABLE IF NOT EXISTS User (ID INT PRIMARY KEY, USERNAME VARCHAR(255) NOT NULL,FIRSTNAME VARCHAR(255) NOT NULL,LASTNAME VARCHAR(255) NOT NULL, EMAIL VARCHAR(255) NOT NULL,PASSWORD VARCHAR(255) NOT NULL,PERMISSION VARCHAR(255) NOT NULL, LAST_CONNECTION_TIME DATETIME, STATUT BOOLEAN)",
